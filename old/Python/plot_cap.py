...
for step in data.keys():
    ...
    elif 'm' in step_str:  # Check for both "µ" and "u" for microseconds
...
cbar.set_label(r'$Capacitance$ ($Farads$)', labelpad=25, rotation=270, fontsize=15)
cbar.ax.tick_params(labelsize=12) 
# Define major ticks at key points only to keep it simple and readable
major_ticks = [1e-3, 1e-2, 1e-1, 1]
